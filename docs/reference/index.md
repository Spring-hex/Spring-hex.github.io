...
- **[Commands](commands.md)** - Complete reference for all 28 CLI commands, including setup, hexagonal architecture generation, CRUD scaffolding, testing, and database migrations
...
3. **CRUD Generators** - Quickly scaffold traditional MVC-style CRUD operations
4. **Database Migrations** - Manage schema migrations with Flyway or Liquibase
